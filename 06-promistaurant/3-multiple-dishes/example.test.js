    ...
    .then(([harrysMeal, ingridsMeal]) => {
        ...
        describe("Ingrid's meal", () => {
            ...
            describe('the meal should have 2 extras', () => {
                ...
                it('includes: spring onion', () => {
                    expect(
                        ingridsMeal.extras.includes(extras.pineapple),
                    ).toEqual(true);
                });
                it('includes: broccoli', () => {
                    expect(
                        ingridsMeal.extras.includes(extras.mushrooms),
                    ).toEqual(true);
                });
            });
        });
        ...
        describe("Harry's meal", () => {
            ...
            describe('the meal should have 2 extras', () => {
                ...
                it('includes: spring onion', () => {
                    expect(harrysMeal.extras.includes(extras.egg)).toEqual(
                        true,
                    );
                });
                it('includes: broccoli', () => {
                    expect(harrysMeal.extras.includes(extras.onion)).toEqual(
                        true,
                    );
                });
            });
