...
export const preparePortion = (size, base) => {
    return new Promise((resolve, reject) => {
        ...
        if (
            ![bases.fineNoodles, bases.riceNoodles, bases.whiteRice].includes(
                base,
            )
        ) {
            reject('Invalid base!');
...
export const addPreparedExtras = (meal, preparedExtras) => {
    return new Promise((resolve, reject) => {
        ...
        setTimeout(() => {
            preparedExtras.forEach((ex) =>
                meal.extras.push(ex.preparedContent),
            );
...
export const bag = (meal) => {
    return new Promise((resolve, reject) => {
        ...
        setTimeout(() => {
            ...
            console.log(
                `Finished bagging meal #${meal.nr} for a total of ${price}€`,
            );
